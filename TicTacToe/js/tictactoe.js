...
function placeXOrO(squareNumber) {
    ...
    if (!selectedSquares.some(element => element.includes(squareNumber))) {
        ...
        if (activePlayer === 'X') {
            ...
            select.style.backgroundImage = 'url("./images/kiss.jpg")';
        } 
...
function checkWinConditions() {
    ...
    function arrayIncludes(squareA, squareB, squareC) {
        ...
        //returned and our else if condition executes the drawWinLine functioj. 
...
//This line access our html canvas element. 
    ...
    //This line gives us accaess to methods and properties to use on canvas.
...
function animateLineDrawing() {
    ...
    c.moveTo(x1, y1) 
    //This ethod indicates the end point in our line. 
    c.lineTo(x, y)
    ...
    if (x1 <= x2 && y1 <= y2) {
        ...
        if (x < x2) {x += 10; }
        //THis condiont adds 10 to the previous end y point. 
        if (y < y2) {y += 10; } 
